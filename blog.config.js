...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TinyTechFlux', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'TinyTechFlux 科技前沿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'TinyTechFlux.com', // 网站地址
